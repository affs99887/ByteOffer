  ...
  return (
    <div data-screen-label="设置" className="bo-enter" style={{ maxWidth: '860px', margin: '0 auto' }}>
      ...
      <div style={{ background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: '12px', padding: '8px 24px', marginBottom: '16px' }}>
        ...
        <a href="/billing" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '15px 0', borderTop: '1px solid var(--divider)', cursor: 'pointer', textDecoration: 'none' }}><span style={{ fontSize: '14px', color: 'var(--ink)' }}>会员状态</span><span style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '12.5px', color: 'var(--pri)', fontWeight: 600 }}>{tier === "plus" ? "Plus · 管理订阅" : "免费版 · 全部功能开放"}<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 6l6 6-6 6"></path></svg></span></a>
