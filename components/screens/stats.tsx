  ...
  return (
    <div data-screen-label="数据统计" className="bo-enter" style={{ maxWidth: '1440px', margin: '0 auto' }}>
      ...
      <div className="bo-stagger" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(202px,1fr))', gap: '14px', marginBottom: '16px' }}>
        <div className="bo-card" style={{ background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: '12px', padding: '17px 18px' }}><div style={{ fontSize: '12.5px', color: 'var(--ink3)', fontWeight: 600 }}>累计刷题</div><div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: '30px', fontWeight: 700, color: 'var(--ink)', lineHeight: 1, marginTop: '13px' }}><CountUp to={v.authed ? v.statTotalLive : 1284} comma /></div><div style={{ marginTop: '10px', fontSize: '12px', color: 'var(--ink3)' }}><span style={{ fontFamily: "'JetBrains Mono',monospace", color: '#0E9F6E', fontWeight: 700 }}>+{v.authed ? v.statTodayLive : 42}</span> 今日</div></div>
