  ...
  return (
    <div data-screen-label="数据统计" className="bo-enter" style={{ maxWidth: '1440px', margin: '0 auto' }}>
      ...
      <div className="bo-stagger" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(202px,1fr))', gap: '14px', marginBottom: '16px' }}>
        <div className="bo-card" style={{ background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: '12px', padding: '17px 18px' }}><div style={{ fontSize: '12.5px', color: 'var(--ink3)', fontWeight: 600 }}>累计刷题</div><div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: '30px', fontWeight: 700, color: 'var(--ink)', lineHeight: 1, marginTop: '13px' }}><CountUp to={v.statsReady ? v.statTotalAttempts : 1284} comma /></div><div style={{ marginTop: '10px', fontSize: '12px', color: 'var(--ink3)' }}><span style={{ fontFamily: "'JetBrains Mono',monospace", color: '#0E9F6E', fontWeight: 700 }}>+{v.statsReady ? v.statTodayCount : 42}</span> 今日</div></div>
        <div className="bo-card" style={{ background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: '12px', padding: '17px 18px' }}><div style={{ fontSize: '12.5px', color: 'var(--ink3)', fontWeight: 600 }}>平均正确率</div><div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: '30px', fontWeight: 700, color: 'var(--ink)', lineHeight: 1, marginTop: '13px' }}><CountUp to={v.statsReady ? v.statAccuracyPct : 76.8} dec={v.statsReady ? 0 : 1} /><span style={{ fontSize: '18px', color: 'var(--ink3)' }}>%</span></div><div style={{ marginTop: '10px', fontSize: '12px', color: 'var(--ink3)' }}>客观题 · 近30天</div></div>
        <div className="bo-card" style={{ background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: '12px', padding: '17px 18px' }}><div style={{ fontSize: '12.5px', color: 'var(--ink3)', fontWeight: 600 }}>学习时长</div><div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: '30px', fontWeight: 700, color: 'var(--ink)', lineHeight: 1, marginTop: '13px' }}><CountUp to={v.statsReady ? v.statStudyHours : 86.5} dec={1} /><span style={{ fontSize: '15px', color: 'var(--ink3)', fontWeight: 500 }}> h</span></div><div style={{ marginTop: '10px', fontSize: '12px', color: 'var(--ink3)' }}>连续 <span style={{ fontFamily: "'JetBrains Mono',monospace", color: 'var(--ink2)', fontWeight: 700 }}>{v.statsReady ? v.statStreak : 18}</span> 天</div></div>
        <div className="bo-card" style={{ background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: '12px', padding: '17px 18px' }}><div style={{ fontSize: '12.5px', color: 'var(--ink3)', fontWeight: 600 }}>全站排名</div><div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: '30px', fontWeight: 700, color: 'var(--ink)', lineHeight: 1, marginTop: '13px' }}>Top 8%</div><div style={{ marginTop: '10px', fontSize: '12px', color: 'var(--ink3)' }}><span style={{ fontFamily: "'JetBrains Mono',monospace", color: '#0E9F6E', fontWeight: 700 }}>↑ 2%</span> 本周</div></div>
      </div>
      ...
      <div style={{ background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: '12px', padding: '20px 22px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(220px,1fr))', gap: '16px 32px' }}>
          {v.statsReady && v.statCategoryBars.length > 0 ? (
